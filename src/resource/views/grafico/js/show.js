$(function() {
  ...
  paciente_id = $("#paciente").attr('data-id');

  $.ajax({
    type:"POST",
    url: "https://grupo36.proyecto2017.linti.unlp.edu.ar/application/grafico/getpaciente",
    ...
    success:function(paciente){
      ...
      if (paciente.genero == 'F') {
        $.ajax({
          type:"POST",
          url: "https://grupo36.proyecto2017.linti.unlp.edu.ar/application/grafico/getcontrolsalud",
          data:({ paciente_id: paciente_id }),
          dataType: "json",
          success:function(controlSalud){
            //console.log(controlSalud);

            var datos = new Array();
            for (var i = 0; i < controlSalud.length; i++) {
              datos.push([controlSalud[i]['edadSemanas'],controlSalud[i]['peso']]);
            }
            pesoMujer.series.push({name: 'Paciente',data: datos});

            var datos = new Array();
            for (var i = 0; i < controlSalud.length; i++) {
              datos.push([controlSalud[i]['talla'],controlSalud[i]['peso']]);
            }
            tallaMujer.series.push({name: 'Paciente',data: datos});
            // console.log(datos);

            var datos = new Array();
            for (var i = 0; i < controlSalud.length; i++) {
              datos.push([controlSalud[i]['edadSemanas'],controlSalud[i]['ppc']]);
            }
            ppcMujer.series.push({name: 'Paciente',data: datos});
            // console.log(datos);

            //console.log(pesoHombre.series);
            $("#pesoMujer").show();
            $("#tallaMujer").show();
            $("#ppcMujer").show();
            Highcharts.chart('pesoMujer', pesoMujer);
            Highcharts.chart('tallaMujer', tallaMujer);
            Highcharts.chart('ppcMujer', ppcMujer);
          },
        ...
        $.ajax({
          ...
          success:function(controlSalud){
            ...
            pesoHombre.series.push({name: 'Paciente',data: datos});
            console.log(datos);
            ...
            tallaHombre.series.push({name: 'Paciente',data: datos});
            // console.log(datos);
            ...
            ppcHombre.series.push({name: 'Paciente',data: datos});
            console.log(datos);
            ...
            $("#tallaHombre").show();
            $("#ppcHombre").show();
            Highcharts.chart('pesoHombre', pesoHombre);
            Highcharts.chart('tallaHombre', tallaHombre);
            Highcharts.chart('ppcHombre', ppcHombre);
          },
          error:function(xhr,err,e){
            alert("Error: " + err + xhr + e);
          }
